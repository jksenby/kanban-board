...
@Component({
  selector: 'app-board',
  standalone: true,
  imports: [CommonModule, FormsModule, CdkDrag, CdkDropList, CdkDropListGroup, RouterModule],
  template: `
    <div class="min-h-screen bg-[#f8fafc] flex flex-col font-sans text-slate-900">
      <!-- Header -->
      <header class="glass sticky top-0 z-50 border-b border-slate-200/60 px-6 lg:px-12 py-4 flex justify-between items-center h-20">
        <div class="flex items-center space-x-4">
          ...
          <div>
            <h1 class="text-xl font-extrabold font-['Outfit'] tracking-tight">{{ boardTitle || 'Loading Project...' }}</h1>
      ...
      <main class="flex-1 p-6 lg:p-12 space-y-10 max-w-[1600px] mx-auto w-full">
        ...
        <!-- Kanban Board -->
        <div class="flex flex-col lg:flex-row gap-8 h-full min-h-[600px]" cdkDropListGroup>
